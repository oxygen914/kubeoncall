...
public class AlarmSuppressionRuleController {
    ...
    public AlarmSuppressionRuleController(
            AlarmSuppressionRuleRepository repository, ExecutionAuditService auditService) {
    ...
    public AlarmSuppressionRuleRepository.ReloadResult reload() {
        ...
        auditService.recordAlarmExecution(
                "alarm-suppression-reload-" + startedAt.toEpochMilli(),
                "SUPPRESSION_RULES_RELOADED",
                true,
                false,
                "Alarm suppression rules reloaded",
                null,
                List.of("alarm.suppression.reload"),
                startedAt,
                Map.of(
                        "previousVersion",
