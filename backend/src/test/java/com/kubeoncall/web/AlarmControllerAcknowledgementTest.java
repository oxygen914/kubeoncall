...
class AlarmControllerAcknowledgementTest {
    ...
    void shouldAcknowledgeAlarmAndWriteAudit() {
        ...
        when(acknowledgementStore.acknowledge(
                        eq("fp-api"), eq("oncall-user"), eq("investigating"), eq(Duration.ofSeconds(600))))
        ...
        AlarmAcknowledgementResponse response =
                controller.acknowledge(new AlarmAcknowledgementRequest("fp-api", "oncall-user", "investigating", 600));
    ...
    void shouldConfirmManualRecoveryWithHealthEvidence() {
        ...
        AlarmController controller = new AlarmController(
                ...
                mock(AlertWorkflowService.class),
                mock(AlarmSilenceApprovalStore.class),
                mock(AlarmAcknowledgementStore.class),
