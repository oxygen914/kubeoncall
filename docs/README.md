...
| [Kubernetes 故障 SOP 真实演练指南](guides/Kubernetes故障SOP真实演练指南.md) | 在专用测试集群重复演练 Pending、CrashLoopBackOff、OOMKilled 和 Node NotReady |
...
| [真实 Kubernetes 只读证据链验收](plans/active/ai-operations/validation/2026-07-30真实Kubernetes只读证据链验收记录.md) | 单节点 Minikube 的资源状态、Events、current/previous Pod logs、鉴权与只读边界实证 |
| [四类 Kubernetes 故障 SOP 真实验收](plans/active/ai-operations/validation/2026-07-30四类Kubernetes故障SOP真实环境验收记录.md) | 四类真实故障的一轮持久化诊断、SOP、证据、恢复结果与剩余缺口 |
